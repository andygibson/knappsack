...
#set( $symbol_escape = '\' )
 ...
 This project is meant for a new Java EE 6 application with little code except a 
 test page and a data provider set up.
 ...
 ================
  ...
  There is just a persistence.xml file and the entity manager production code as
  well as single page that verifies that JSF is working. 
